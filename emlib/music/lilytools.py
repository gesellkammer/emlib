...
logger = logging.getLogger("emlib.lilytools")
...
def _check_output(args: t.List[str], encoding="utf-8") -> _str:
    """
...
def postprocess(lilyfile:str, outfile:str, remove_header=True, book=True) -> None:
    import re
