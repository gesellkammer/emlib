...
def butn(seq: Iter[T], n: int) -> Iter[T]:
    """
    iterate over seq[:-n]
    """
    seqi = iter(seq)
...
def intercalate(seq: Iter[T], item) -> Iter[T]:
    """
...
def mesh(xs: Iter[T], ys: Iter[T2]) -> Iter[Tup[T, T2]]:
    """
